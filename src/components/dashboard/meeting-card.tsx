...
const MeetingCard = () => {
    ...
    const { getRootProps, getInputProps } = useDropzone({
        ...
        multiple: false,
        // Increasing to 150MB to accommodate larger files (size in bytes)
        maxSize: 150_000_000,
        onDrop: async acceptedFiles => {
            if (!project) return
                ...
                // Call uploadFile with the file object - use type assertion to satisfy TypeScript
    ...
    return (
        <Card className='col-span-2 flex flex-col items-center justify-center p-10' {...getRootProps()}>
            {!isUploading && (
                ...
                <h3 className='mt-2 text-sm font-semibold text-gray-900 text-center items-center'>
            ...
            {isUploading && (
                ...
                <div className=''>
                    <CircularProgressbar
                        value={progress}
                        text={`${progress}%`} className="size-20" styles={
                            buildStyles({
                                pathColor: '#0070f3',
                                textColor: '#0070f3',
                    ...
                    />
                    <p className='text-gray-500 text-sm text-center'>Uploading your meeting...</p>
                </div>
                </>
            )}
        </Card>
